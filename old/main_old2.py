        ...
        if WIN32_AVAILABLE:
            try:
                ...
                if isinstance(content, Image.Image):
                    ...
                    p.set_with_default(align='left', font='a', bold=False, underline=0, width=1, height=1, density=9, invert=False, smooth=False, flip=False, double_width=False, double_height=False, custom_size=False)
                    p.set(
                        align='left', # align (Optional[str]) – horizontal position for text, possible values are:’center’, ’left’, ’right’
                        font='a', # font (Optional[str]) – font given as an index, a name, or one of the special values ‘a’ or ‘b’, referring to fonts 0 and 1.
                        bold=True, # bold (Optional[bool]) – text in bold
                        underline=None, # underline (Optional[int]) – underline mode for text, decimal range 0-2
                        width=None, # width (Optional[int]) – text width multiplier when custom_size is used, decimal range 1-8
                        height=None, # height (Optional[int]) – text height multiplier when custom_size is used, decimal range 1-8
                        density=None, # density (Optional[int]) – print density, value from 0-8, if something else is supplied the density remains unchanged
                        invert=None, # invert (Optional[bool]) – True enables white on black printing
                        smooth=None, # smooth (Optional[bool]) – True enables text smoothing. Effective on 4x4 size text and larger
                        flip=None, # flip (Optional[bool]) – True enables upside-down printing
                        normal_textsize=None,  # normal_textsize (Optional[bool]) – switch to normal text size if True
                        double_width=None,  # double_width (Optional[bool]) – doubles the width of the text
                        double_height=None,  # double_height (Optional[bool]) – doubles the height of the text
                        custom_size=None # custom_size (Optional[bool]) – uses custom size specified by width and height parameters. Cannot be used with double_width or double_height.
                    )
                    p.textln("Hello,")           
                    p.set(
                        align='right', # align (Optional[str]) – horizontal position for text, possible values are:’center’, ’left’, ’right’
                        font='b', # font (Optional[str]) – font given as an index, a name, or one of the special values ‘a’ or ‘b’, referring to fonts 0 and 1.
                        bold=False, # bold (Optional[bool]) – text in bold
                        underline=True, # underline (Optional[int]) – underline mode for text, decimal range 0-2
                        width=8, # width (Optional[int]) – text width multiplier when custom_size is used, decimal range 1-8
                        height=8, # height (Optional[int]) – text height multiplier when custom_size is used, decimal range 1-8
                        density=8, # density (Optional[int]) – print density, value from 0-8, if something else is supplied the density remains unchanged
                        invert=None, # invert (Optional[bool]) – True enables white on black printing
                        smooth=None, # smooth (Optional[bool]) – True enables text smoothing. Effective on 4x4 size text and larger
                        flip=None, # flip (Optional[bool]) – True enables upside-down printing
                        normal_textsize=None,  # normal_textsize (Optional[bool]) – switch to normal text size if True
                    ...
                    p.textln("Curtis")
                    p.set(
                        align='center', # align (Optional[str]) – horizontal position for text, possible values are:’center’, ’left’, ’right’
                        font='b', # font (Optional[str]) – font given as an index, a name, or one of the special values ‘a’ or ‘b’, referring to fonts 0 and 1.
                        bold=False, # bold (Optional[bool]) – text in bold
                        underline=True, # underline (Optional[int]) – underline mode for text, decimal range 0-2
                        width=5, # width (Optional[int]) – text width multiplier when custom_size is used, decimal range 1-8
                        height=4, # height (Optional[int]) – text height multiplier when custom_size is used, decimal range 1-8
                        density=4, # density (Optional[int]) – print density, value from 0-8, if something else is supplied the density remains unchanged
                        invert=True, # invert (Optional[bool]) – True enables white on black printing
                        smooth=True, # smooth (Optional[bool]) – True enables text smoothing. Effective on 4x4 size text and larger
                        flip=True, # flip (Optional[bool]) – True enables upside-down printing
                        normal_textsize=None,  # normal_textsize (Optional[bool]) – switch to normal text size if True
                        double_width=None,  # double_width (Optional[bool]) – doubles the width of the text
                        double_height=None,  # double_height (Optional[bool]) – doubles the height of the text
                        custom_size=None # custom_size (Optional[bool]) – uses custom size specified by width and height parameters. Cannot be used with double_width or double_height.
                    ...
                    p.set(
                        ...
                        bold=False, # bold (Optional[bool]) – text in bold
                        underline=True, # underline (Optional[int]) – underline mode for text, decimal range 0-2
                        width=0, # width (Optional[int]) – text width multiplier when custom_size is used, decimal range 1-8
                        height=0, # height (Optional[int]) – text height multiplier when custom_size is used, decimal range 1-8
                        density=0, # density (Optional[int]) – print density, value from 0-8, if something else is supplied the density remains unchanged
                        invert=False, # invert (Optional[bool]) – True enables white on black printing
                        smooth=False, # smooth (Optional[bool]) – True enables text smoothing. Effective on 4x4 size text and larger
                        flip=None, # flip (Optional[bool]) – True enables upside-down printing
                        normal_textsize=None,  # normal_textsize (Optional[bool]) – switch to normal text size if True
                        double_width=None,  # double_width (Optional[bool]) – doubles the width of the text
                        double_height=None,  # double_height (Optional[bool]) – doubles the height of the text
                ...
                # p.ln(2)
                p.cut()
                # cut(mode='FULL', feed=True)[fuente] Cortar papel.
                # Sin argumentos, el papel se cortará completamente. Con 'mode=PART' se intentará un corte parcial. Sin embargo, tenga en cuenta que no todos los modelos permiten realizar cortes parciales. Consulte la documentación de su impresora para obtener más información.
                # Parámetros
                # : modo ( str) – se establece en 'PART' para un corte parcial. predeterminado: 'FULL'
                # : feed ( bool) – imprime y alimenta antes de cortar. Predeterminado: True
                # Aumenta
                # : ValueError – si el modo no está en ('FULL', 'PART')
                # Tipo de retorno
                # : None
